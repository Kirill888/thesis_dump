...
in these sets do not correspond (see \refFigure{fig:mirror_sets}).
...
The maximum of the \refEquation{eqn:align} can be used as a measure of
...
is outlined in a section~\ref{sec:map_alignment} on map alignment .
...
\refFigure{fig:hump} illustrates. In this example robot assumes a
...
\SILENT{ Example: sum of K random variables (assume uniform -1 0 1) is
