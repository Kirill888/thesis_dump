...
%\item The initial map region is computed and assigned to the new map.
%  All the neighbouring regions are then projected into the new
%  coordinate frame and are subtracted from the initial map region to
%  force the non-overlapping constraint.
%
