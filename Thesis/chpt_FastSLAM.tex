...
faster CPUs, algorihtms that are best suited to exploit new computer
architecture will see the most improvement from progress in hardware.


\subsection{Effect of Ambiguous Data Association on Posterior Distribution}
