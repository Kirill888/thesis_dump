...
report. \refTable{tab:notation} summarises most of the symbols used in
this thesis.
...
\refEquation{eqn:kalman_sigma_u}, constitute the update stage of the
...
No direct measurement of the state is available. Instead state is
