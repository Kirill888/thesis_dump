...
environment. As the robot moves through an unexplored environment
while building the map, it becomes more and more uncertain about its
pose relative to the regions it mapped in the past. The increase in
the uncertainty makes it hard for the robot to detect when it comes
back to the region it has mapped already. Failure to detect revisiting
results in an inconsistent map.
